...
async function Lawyers() {
    ...
    const [selectedSpecialty, setSelectedSpecialty] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("All");
    const [selectedLocation, setSelectedLocation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("All");
    const specialties = [
        "All",
        "Criminal Law",
        "Corporate Law",
    ...
    // ========== Getting Lawyer List ==============
    const { data: allLawyers, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "AllLawyers",
            selectedSpecialty,
            selectedLocation
        ],
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$lawyersService$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllLawyers"]
    });
    if (isLoading) {
    ...
    const filteredLawyers = allLawyers?.data?.data?.filter((lawyer)=>{
        const specArray = Array.isArray(lawyer?.specilization) ? lawyer.specilization : lawyer?.specilization ? [
            lawyer.specilization
        ] : [];
        const name = lawyer?.name || lawyer?.full_name || ""; // fallback if `name` missing
        const search = searchTerm?.toLowerCase() || "";
        const matchesSearch = name.toLowerCase().includes(search) || specArray.some((spec)=>spec.toLowerCase().includes(search));
        const matchesSpecialty = selectedSpecialty === "All" || specArray.some((spec)=>spec.toLowerCase() === selectedSpecialty.toLowerCase());
        const matchesLocation = selectedLocation === "All" || lawyer?.location?.toLowerCase() === selectedLocation.toLowerCase();
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: specialties.map((specialty)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: specialty,
                                                        children: specialty
                                                    }, specialty, false, {
                                                        fileName: "[project]/app/lawyers-list/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                className: "border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent",
                                                children: locations.map((location)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: location,
                                                        children: location
                                                    }, location, false, {
                                                        fileName: "[project]/app/lawyers-list/page.tsx",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60db26f8._.js.map